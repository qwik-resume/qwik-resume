module.exports = {
    ...
    rules: {
        ...
        'import/extensions': [
            'error',
            'ignorePackages',
            {ts: 'never', tsx: 'never', js: 'never', mjs: 'never', jsx: 'never'}
        ],
        'import/order': [
            'error',
            {
        ...
        'import/no-cycle': ['error', {maxDepth: '∞', ignoreExternal: false, allowUnsafeDynamicCyclicDependency: false}],
        ...
        'id-denylist': ['error', { min: 3, max: 16, exceptions: ['x', 'y', 'z', 'i']}],
        'id-length': ['off'],
        'id-match': ['off'],
        ...
        'sort-keys': ['error', 'asc', {caseSensitive: false, natural: true, allowLineSeparatedGroups: true}],
