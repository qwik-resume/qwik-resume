module.exports = {
  ...
  rules: {
    ...
    'strict': ['error', 'never'],
    'import/no-unresolved': ['off', {commonjs: true, caseSensitive: true, caseSensitiveStrict: false}],
    'import/named': ['error'],
    ...
    'sort-keys': ['off', 'asc', {caseSensitive: false, natural: true, allowLineSeparatedGroups: true}],
